...
public class Main {
    ...
    private static String inputMethodNumber(@NotNull String action, @NotNull Scanner input) {

        System.out.println("Choose method for " + action + " maze:");
        if (action.equals("solving")) {
            System.out.println("(1 - for BFS, 2 - for DFS, 3 - for DFS (MultiThread))");
        } else {
    ...
    public static void main(String[] args) {
        ...
        switch (methodSolve) {
            ...
            case "3" -> DFSSolverMultiThread.solveMaze(maze, start, end);
